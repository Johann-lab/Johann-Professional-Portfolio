      ...
      <div className={`min-h-screen transition-colors ${
        ...
        <section className="pt-32 pb-16 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="mb-16 text-center">
              <div className="h-12 w-72 bg-gray-300 dark:bg-gray-700 rounded mx-auto mb-6 animate-pulse" />
              ...
              <div className="mt-8 grid gap-3 md:grid-cols-[minmax(0,1fr)_minmax(12rem,14rem)_auto_auto] items-center">
                ...
                <div className="h-12 bg-gray-300 dark:bg-gray-700 rounded-lg animate-pulse" />
                <div className="h-12 w-12 bg-gray-300 dark:bg-gray-700 rounded-lg animate-pulse" />
                <div className="h-12 w-12 bg-gray-300 dark:bg-gray-700 rounded-lg animate-pulse" />
              </div>
            </div>
            <div className="space-y-4">
              {skeletons.map((i) => (
                <div key={i} className="rounded-xl border-2 p-7 animate-pulse">
        ...
        <footer className="bg-[#0F172A] text-[#94A3B8] py-12 text-center border-t border-[#334155]/50">
          <div className="mb-8 flex justify-center gap-6 flex-wrap">
            {[
              {
                icon: <img src="https://thesvg.org/icons/gmail/default.svg" alt="Gmail" className="w-6 h-6 brightness-0 invert shrink-0" />,
                bgColorDark: "bg-red-600"
              },
              {
                icon: <img src="https://thesvg.org/icons/linkedin/default.svg" alt="LinkedIn" className="w-6 h-6 brightness-0 invert shrink-0" />,
                bgColorDark: "bg-blue-700"
              },
              {
                icon: <img src="https://thesvg.org/icons/discord/default.svg" alt="Discord" className="w-6 h-6 brightness-0 invert shrink-0" />,
                bgColorDark: "bg-indigo-700"
              },
              {
                icon: <img src="https://thesvg.org/icons/github/default.svg" alt="GitHub" className="w-6 h-6 shrink-0" />,
                bgColorDark: "bg-gray-200"
              },
              {
                icon: <img src="https://thesvg.org/icons/facebook/default.svg" alt="Facebook" className="w-6 h-6 shrink-0" />,
                bgColorDark: "bg-blue-600"
              },
              {
                icon: <img src="https://thesvg.org/icons/vercel/default.svg" alt="Vercel" className="w-6 h-6 brightness-0 invert shrink-0" />,
                bgColorDark: "bg-gray-900"
              },
            ].map((contact, i) => (
              <div key={i} className={`w-12 h-12 rounded-full ${contact.bgColorDark} animate-pulse`} />
            ))}
          </div>
